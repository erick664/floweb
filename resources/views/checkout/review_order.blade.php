...
@section('content')
    <div class="container">
        <div class="step-one">
            <h2 class="heading">Enviar Hacia</h2>
        </div>
        <div class="row">
            <form action="{{url('/submit-order')}}" method="post" class="form-horizontal">
                ...
                <div class="col-sm-12">
                    ...
                    <section id="cart_items">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <table class="table table-condensed total-result">
                                            <tr>
                                                <td>Carrito Sub Total</td>
                                                <td>$ {{$total_price}}</td>
                                            </tr>
                                            @if(Session::has('discount_amount_price'))
                                                <tr class="shipping-cost">
                                                    <td>Cupon de Descuento</td>
                        ...
                        <span>
                            <label><input type="radio" name="payment_method" value="COD" checked> Pagar con entrega</label>
                        </span>
                            <span>
                            <label><input type="radio" name="payment_method" value="Paypal"> Paypal</label>
                        </span>
                            <button type="submit" class="btn btn-primary" style="float: right;">Ordenar Ahor!</button>
                        </div>
                    </section>
