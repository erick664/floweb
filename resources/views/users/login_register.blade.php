            ...
            <div class="col-sm-4">
                <div class="signup-form"><!--sign up form-->
                    ...
                    <form action="{{url('/register_user')}}" method="post" class="form-horizontal">
                        ...
                        <input type="email" placeholder="Correo Email" name="email" value="{{old('email')}}"/>
                        <span class="text-danger">{{$errors->first('email')}}</span>

                        <input type="password" placeholder="Password" name="password" value="{{old('password')}}"/>
                        <span class="text-danger">{{$errors->first('password')}}</span>

                        <input type="password" placeholder="Confirmar Password" name="password_confirmation" value="{{old('password_confirmation')}}"/>
